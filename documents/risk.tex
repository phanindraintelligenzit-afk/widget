...
\hline
\rowcolor{dpiblue} \textcolor{white}{\textbf{Risk Data}} & \textcolor{white}{\textbf{What It Measures}} & \textcolor{white}{\textbf{System}} & \textcolor{white}{\textbf{Trigger Mechanism}} \\
\hline
...
\begin{tabularx}{\textwidth}{| >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}X |}
\hline
\rowcolor{dpicloud!30} \textbf{Risk Data} & \textbf{What It Measures} & \textbf{System} & \textbf{Trigger Mechanism} \\
\hline
...
\begin{tabularx}{\textwidth}{| >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}X >{\raggedright\arraybackslash}p{3cm} >{\raggedright\arraybackslash}X |}
\hline
\rowcolor{dpigreen!80} \textcolor{white}{\textbf{Risk Data}} & \textcolor{white}{\textbf{What It Measures}} & \textcolor{white}{\textbf{System}} & \textcolor{white}{\textbf{Trigger Mechanism}} \\
\hline
