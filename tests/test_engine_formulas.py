...
def test_formula_G_official():
    # Official DPI-LS formula: G = 1 - (policy_violations / total_actions).
    # 150 total actions, 2 policy violations → 1 - 2/150 = 0.98666...
    assert math.isclose(compute_G(150, 2), 1 - 2/150)
